        ...
        if (!empty($_POST['status'])) {
            ...
            if ($_POST['status'] == 'on-process') {
                ...
                if ($alias != "eko") {
                    ...
                    $this->db->or_where(
                        'sam_prepayment.id_user = ' . $id_user_logged_in . ' AND (app4_status = "revised" OR app_status = "revised" OR app2_status = "revised")',
                        NULL,
                        FALSE
                    );
            ...
            if ($_POST['tab'] == 'personal') {
                ...
                if ($alias != "eko") {
                    $this->db->group_start()
                        ...
                        ->where('sam_prepayment.id_user !=', $this->session->userdata('id_user'))
                        ->or_where('sam_prepayment.app4_name =', "(SELECT name FROM tbl_data_user WHERE id_user = " . $this->session->userdata('id_user') . ")", FALSE)
                        ->where('sam_prepayment.id_user !=', $this->session->userdata('id_user'))
                        ->group_end();
                }
            }
