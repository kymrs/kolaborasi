...
class M_mac_mekanik extends CI_Model
{
    var $id            = 'id';
    var $table         = 'mac_mekanik';
    var $column_order  = [null, null, 'nama', 'npk', 'cabang', 'no_telp', 'alamat', 'created_at'];
    var $column_search = ['nama', 'npk', 'no_telp', 'alamat', 'cabang'];
    var $order         = ['id' => 'desc'];
