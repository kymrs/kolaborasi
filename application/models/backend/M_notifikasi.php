...
class M_notifikasi extends CI_Model
{
    function pending_notification()
    {
        ...
        $data['notif_pending'] = [
            ...
            'prepayment_by_moment' => $this->db->select('id')->from('tbl_prepayment_by_moment')->where('app_name', $app)->where('app_status', 'waiting')->or_where('app2_name', $app)->where('app_status', 'approved')->where('app2_status', 'waiting')->get()->num_rows(),
            ...
            'reimbust_by_moment' => $this->db->select('id')->from('tbl_reimbust_by_moment')->where('app_name', $app)->where('app_status', 'waiting')->or_where('app2_name', $app)->where('app_status', 'approved')->where('app2_status', 'waiting')->get()->num_rows(),
            ...
            'datadeklarasi_by_moment' => $this->db->select('id')->from('tbl_deklarasi_by_moment')->where('app_name', $app)->where('app_status', 'waiting')->or_where('app2_name', $app)->where('app_status', 'approved')->where('app2_status', 'waiting')->get()->num_rows(),
            ...
            'datanotifikasi_by_moment' => $this->db->select('id')->from('tbl_notifikasi_by_moment')->where('app_hc_name', $app)->where('app_hc_status', 'waiting')->or_where('app2_name', $app)->where('app_hc_status', 'approved')->where('app2_status', 'waiting')->get()->num_rows(),
            'approval_sw' => '',
            'approval' => '',
            'penawaran_la_pu' => '',
            'penawaran_pu' => '',
