...
class Mac_reimpayment extends CI_Controller
{
    ...
    //     $data['id'] = 0;
    //     $data['aksi'] = 'add';
    //     $data['rek_options'] = $this->M_mac_reimpayment->options($id_user)->result_array();
    //     $data['title_view'] = "Reimbust Form";
    //     $data['title'] = 'backend/mac_reimpayment/mac_reimbust_form';
    //     $this->load->view('backend/home', $data);
    // }
    ...
    //     $kode = $this->M_mac_reimpayment->max_kode($date)->row();
    ...
    //     $data['id_pembuat'] = $this->M_mac_reimpayment->get_by_id($id)->id_user;

    //     $data['id'] = $id;
    //     $data['aksi'] = 'update';
    //     $data['title_view'] = "Edit Reimbust";
    //     $data['rek_options'] = $this->M_mac_reimpayment->options($data['id_user'])->result_array();
    //     $data['title'] = 'backend/mac_reimpayment/mac_reimbust_form';
    //     $this->load->view('backend/home', $data);
    // }
    ...
    //     if ($valid) {
    //         $reimbust_id = $this->M_mac_reimpayment->save($data1);
    //     }
    ...
    //     $this->M_mac_reimpayment->save_detail($data2);
    ...
    // function delete($id)
    // {
    //     $this->M_mac_reimpayment->delete($id);
    //     echo json_encode(array("status" => TRUE));
    // }
