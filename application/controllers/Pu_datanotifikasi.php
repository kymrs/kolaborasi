...
class Pu_datanotifikasi extends CI_Controller
{

    function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_pu_datanotifikasi');
    ...
    public function index()
    {
        ...
        $data['title'] = "backend/pu_datanotifikasi/notifikasi_list_pu";
    ...
    function get_list()
    {
        ...
        $list = $this->M_pu_datanotifikasi->get_datatables($status);
        $data = array();
        $no = $_POST['start'];
        ...
        foreach ($list as $field) {
            ...
            $action_read = ($read == 'Y') ? '<a href="pu_datanotifikasi/read_form/' . $field->id . '" class="btn btn-info btn-circle btn-sm" title="Read"><i class="fa fa-eye"></i></a>&nbsp;' : '';
            $action_edit = ($edit == 'Y') ? '<a href="pu_datanotifikasi/edit_form/' . $field->id . '" class="btn btn-warning btn-circle btn-sm" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;' : '';
            $action_delete = ($delete == 'Y') ? '<a onclick="delete_data(' . "'" . $field->id . "'" . ')" class="btn btn-danger btn-circle btn-sm" title="Delete"><i class="fa fa-trash"></i></a>&nbsp;' : '';
            $action_print = ($print == 'Y') ? '<a class="btn btn-success btn-circle btn-sm" target="_blank" href="pu_datanotifikasi/generate_pdf/' . $field->id . '"><i class="fas fa-file-pdf"></i></a>' : '';
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_pu_datanotifikasi->count_all(),
            "recordsFiltered" => $this->M_pu_datanotifikasi->count_filtered(),
            "data" => $data,
        );
    ...
    {
        $data['id'] = $id;
        $data['user'] = $this->M_pu_datanotifikasi->get_by_id($id);
        ...
        $data['title'] = 'backend/pu_datanotifikasi/notifikasi_read_pu';
        $this->load->view('backend/home', $data);
    }
    ...
    public function generate_kode()
    {
        ...
        $kode = $this->M_pu_datanotifikasi->max_kode($date)->row();
    ...
    function add_form()
    {
        ...
        $data['title'] = 'backend/pu_datanotifikasi/notifikasi_form_pu';
        $this->load->view('backend/home', $data);
    }
    ...
    {
        $data['master'] = $this->M_pu_datanotifikasi->get_by_id($id);
    ...
    public function update()
    {
        ...
        $this->db->update('pu_notifikasi', $data);
        echo json_encode(array("status" => TRUE));
    }

    function delete($id)
    {
        $this->M_pu_datanotifikasi->delete($id);
        echo json_encode(array("status" => TRUE));
    }
