...
class Sml_datadeklarasi extends CI_Controller
{

    function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_sml_datadeklarasi');
    ...
    public function index()
    {
        ...
        $data['title'] = "backend/sml_datadeklarasi/sml_deklarasi_list";
    ...
    function get_list()
    {
        ...
        $fullname = $this->db->select('name')
            ...
            ->get()
            ->row('name');
        $list = $this->M_sml_datadeklarasi->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_sml_datadeklarasi->count_all(),
            "recordsFiltered" => $this->M_sml_datadeklarasi->count_filtered(),
            "data" => $data,
        );
    ...
    function read_form($id)
    {
        ...
        $data['id'] = $id;
        $data['user'] = $this->M_sml_datadeklarasi->get_by_id($id);
        ...
        $data['title'] = 'backend/sml_datadeklarasi/sml_deklarasi_read';
        $this->load->view('backend/home', $data);
    }
    ...
    function add_form()
    {
        ...
        $data['aksi'] = 'update';
        $data['title'] = 'backend/sml_datadeklarasi/sml_deklarasi_form';
        $this->load->view('backend/home', $data);
    }
    ...
    function edit_form($id)
    {
        ...
        $data['id_pembuat'] = $this->M_sml_datadeklarasi->get_by_id($id)->id_pengaju;
    ...
    {
        $data['master'] = $this->M_sml_datadeklarasi->get_by_id($id);
    ...
    public function generate_kode()
    {
        ...
        $kode = $this->M_sml_datadeklarasi->max_kode($date)->row();
    ...
    public function update()
    {
        ...
        $this->db->update('sml_deklarasi', $data);
        echo json_encode(array("status" => TRUE));
    }

    function delete($id)
    {
        $this->M_sml_datadeklarasi->delete($id);
        echo json_encode(array("status" => TRUE));
    }
