...
class Rekapitulasi_kps extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_rekapitulasi_kps');
    ...
    public function index()
    {
        ...
        $data['total'] = $this->M_rekapitulasi_kps->get_total_pengeluaran();
    ...
    function get_list()
    {
        ...
        $list = $this->M_rekapitulasi_kps->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_rekapitulasi_kps->count_all(),
            "recordsFiltered" => $this->M_rekapitulasi_kps->count_filtered(),
            "data" => $data,
        );
    ...
    function get_total()
    {
        $output = $this->M_rekapitulasi_kps->get_total_pengeluaran();
    ...
    public function export_excel()
    {
        ...
        $prepayment = $this->M_rekapitulasi_kps->get_data_prepayment($tgl_awal, $tgl_akhir);
        $reimbust = $this->M_rekapitulasi_kps->get_data_reimbust($tgl_awal, $tgl_akhir);
