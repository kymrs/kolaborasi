...
class Datanotifikasi_pw extends CI_Controller
{

    function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_datanotifikasi_pw');
    ...
    public function index()
    {
        ...
        $data['title'] = "backend/datanotifikasi_pw/notifikasi_list_pw";
    ...
    function get_list()
    {
        ...
        $list = $this->M_datanotifikasi_pw->get_datatables($status);
        $data = array();
        $no = $_POST['start'];
        ...
        foreach ($list as $field) {
            ...
            $action_read = ($read == 'Y') ? '<a href="datanotifikasi_pw/read_form/' . $field->id . '" class="btn btn-info btn-circle btn-sm" title="Read"><i class="fa fa-eye"></i></a>&nbsp;' : '';
            $action_edit = ($edit == 'Y') ? '<a href="datanotifikasi_pw/edit_form/' . $field->id . '" class="btn btn-warning btn-circle btn-sm" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;' : '';
            $action_delete = ($delete == 'Y') ? '<a onclick="delete_data(' . "'" . $field->id . "'" . ')" class="btn btn-danger btn-circle btn-sm" title="Delete"><i class="fa fa-trash"></i></a>&nbsp;' : '';
            $action_print = ($print == 'Y') ? '<a class="btn btn-success btn-circle btn-sm" target="_blank" href="datanotifikasi_pw/generate_pdf/' . $field->id . '"><i class="fas fa-file-pdf"></i></a>' : '';
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_datanotifikasi_pw->count_all(),
            "recordsFiltered" => $this->M_datanotifikasi_pw->count_filtered(),
            "data" => $data,
        );
    ...
    {
        $data['id'] = $id;
        $data['user'] = $this->M_datanotifikasi_pw->get_by_id($id);
        ...
        $data['title'] = 'backend/datanotifikasi_pw/notifikasi_read_pw';
        $this->load->view('backend/home', $data);
    }
    ...
    public function generate_kode()
    {
        ...
        $kode = $this->M_datanotifikasi_pw->max_kode($date)->row();
    ...
    function add_form()
    {
        ...
        $data['title'] = 'backend/datanotifikasi_pw/notifikasi_form_pw';
        $this->load->view('backend/home', $data);
    }
    ...
    {
        $data['master'] = $this->M_datanotifikasi_pw->get_by_id($id);
    ...
    public function add()
    {
        ...
        $approval = $this->M_datanotifikasi_pw->approval($this->session->userdata('id_user'));
        ...
        $this->M_datanotifikasi_pw->save($data);
    ...
    public function update()
    {
        ...
        $this->db->update('tbl_notifikasi_pw', $data);
        echo json_encode(array("status" => TRUE));
    }

    function delete($id)
    {
        $this->M_datanotifikasi_pw->delete($id);
        echo json_encode(array("status" => TRUE));
    }
