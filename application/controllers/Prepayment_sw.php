...
class Prepayment_sw extends CI_Controller
{
    ...
    function edit_data($id)
    {
        ...
        $data['event'] = $this->db->select('event_name')->from('tbl_event')->where('id', $event_id)->get()->row('event_name');
    ...
    public function add_event()
    {
        ...
        // Menggunakan db->replace untuk memasukkan atau menggantikan data
        $this->db->replace('tbl_event', $data);
    ...
    public function generate_pdf($id)
    {
        ...
        $data['user'] = $this->db->select('name')
            ...
            ->get()
            ->row('name');
        $data['event_name'] = $this->db->select('event_name')->from('tbl_event')->where('id', $data['master']->event)->get()->row('event_name');
