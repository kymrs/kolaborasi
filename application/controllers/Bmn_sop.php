...
class Bmn_sop extends CI_Controller
{
    ...
    function read_form($id)
    {
        ...
        $data['title'] = 'backend/bmn_sop/sop_read_bmn';
        $this->load->view('backend/home', $data);
    }
    ...
    function add_form()
    {
        ...
        $data['title'] = 'backend/bmn_sop/sop_form_bmn';
        $this->load->view('backend/home', $data);
    }
    ...
    public function add()
    {
        ...
        // Config upload
        $config['upload_path'] = './assets/backend/document/sop/bmn_sop';
    ...
    public function update()
    {
        ...
        if (!empty($_FILES['file']['name'])) {
            if ($this->upload->do_upload('file')) {
                ...
                if (!empty($old_file) && file_exists('assets/backend/document/sop/bmn_sop/' . $old_file)) {
                    unlink('assets/backend/document/sop/bmn_sop/' . $old_file);
                }
            } else {
                // Upload failed
                $error = $this->upload->display_errors();
    ...
    public function delete($id)
    {
        ...
        if (!empty($file)) {
            ...
            $fullPath = rtrim(FCPATH, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . 'assets' . DIRECTORY_SEPARATOR . 'backend' . DIRECTORY_SEPARATOR . 'document' . DIRECTORY_SEPARATOR . 'sop' . DIRECTORY_SEPARATOR . 'bmn_sop' . DIRECTORY_SEPARATOR . $safeFile;
            if (is_file($fullPath)) {
                @unlink($fullPath);
            }
        }
