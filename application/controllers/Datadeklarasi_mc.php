...
class Datadeklarasi_mc extends CI_Controller
{

    function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_datadeklarasi_mc');
    ...
    public function index()
    {
        ...
        $data['title'] = "backend/datadeklarasi_mc/deklarasi_list_mc";
    ...
    function get_list()
    {
        ...
        $fullname = $this->db->select('name')
            ...
            ->get()
            ->row('name');
        $list = $this->M_datadeklarasi_mc->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        foreach ($list as $field) {
            ...
            $action_read = ($read == 'Y') ? '<a href="datadeklarasi_mc/read_form/' . $field->id . '" class="btn btn-info btn-circle btn-sm" title="Read"><i class="fa fa-eye"></i></a>&nbsp;' : '';
            $action_edit = ($edit == 'Y') ? '<a href="datadeklarasi_mc/edit_form/' . $field->id . '" class="btn btn-warning btn-circle btn-sm" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;' : '';
            $action_delete = ($delete == 'Y') ? '<a onclick="delete_data(' . "'" . $field->id . "'" . ')" class="btn btn-danger btn-circle btn-sm" title="Delete"><i class="fa fa-trash"></i></a>&nbsp;' : '';
            $action_print = ($print == 'Y') ? '<a class="btn btn-success btn-circle btn-sm" target="_blank" href="datadeklarasi_mc/generate_pdf/' . $field->id . '"><i class="fas fa-file-pdf"></i></a>' : '';
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_datadeklarasi_mc->count_all(),
            "recordsFiltered" => $this->M_datadeklarasi_mc->count_filtered(),
            "data" => $data,
        );
    ...
    function read_form($id)
    {
        $data['notif'] = $this->M_notifikasi->pending_notification();
        $data['id'] = $id;
        $data['user'] = $this->M_datadeklarasi_mc->get_by_id($id);
        ...
        $data['title'] = 'backend/datadeklarasi_mc/deklarasi_read_mc';
        $this->load->view('backend/home', $data);
    }
    ...
    function add_form()
    {
        ...
        $data['aksi'] = 'update';
        $data['title'] = 'backend/datadeklarasi_mc/deklarasi_form_mc';
        $this->load->view('backend/home', $data);
    }
    ...
    {
        $data['master'] = $this->M_datadeklarasi_mc->get_by_id($id);
    ...
    public function generate_kode()
    {
        ...
        $kode = $this->M_datadeklarasi_mc->max_kode($date)->row();
    ...
    public function add()
    {
        ...
        $approval = $this->M_datadeklarasi_mc->approval($this->session->userdata('id_user'));
        ...
        $this->M_datadeklarasi_mc->save($data);
    ...
    public function update()
    {
        ...
        $this->db->update('mc_deklarasi', $data);
        echo json_encode(array("status" => TRUE));
    }

    function delete($id)
    {
        $this->M_datadeklarasi_mc->delete($id);
        echo json_encode(array("status" => TRUE));
    }
