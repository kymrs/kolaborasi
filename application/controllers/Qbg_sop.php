...
class Qbg_sop extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('backend/M_qbg_sop');
    ...
    {
        $data['title'] = "backend/qbg_sop/qbg_sop_list";
        $data['titleview'] = "SOP";
    ...
    function get_list()
    {
        ...
        $list = $this->M_qbg_sop->get_all_with_hierarchy();
    ...
    function get_id($id)
    {
        $data = $this->M_qbg_sop->get_by_id($id);
    ...
    public function update()
    {
        ...
        $old_data = $this->M_qbg_sop->get_by_id($id);
        ...
        $this->M_qbg_sop->update($id, $data);
        echo json_encode(array("status" => TRUE));
    }

    public function delete($id)
    {
        $row = $this->M_qbg_sop->get_by_id($id);
    ...
    public function get_parent_options()
    {
        ...
        $parent_options = $this->M_qbg_sop->get_parent_options($jenis);
