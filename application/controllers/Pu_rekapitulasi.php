...
class Pu_rekapitulasi extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_pu_rekapitulasi');
    ...
    public function index()
    {
        ...
        $data['total'] = $this->M_pu_rekapitulasi->get_total_pengeluaran();

        $data['title'] = "backend/pu_rekapitulasi";
    ...
    function get_list()
    {
        ...
        $list = $this->M_pu_rekapitulasi->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_pu_rekapitulasi->count_all(),
            "recordsFiltered" => $this->M_pu_rekapitulasi->count_filtered(),
            "data" => $data,
        );
