...
class sw_sop extends CI_Controller
{

    function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_sw_sop');
    ...
    {
        $data['title'] = "backend/sw_sop/sw_sop_list";
        $data['titleview'] = "SOP";
    ...
    function get_list()
    {
        ...
        $list = $this->M_sw_sop->get_all_with_hierarchy();
    ...
    {
        $data['master'] = $this->M_sw_sop->get_by_id($id);
        $data['title_view'] = "Data SOP";
        $data['title'] = 'backend/sw_sop/sop_read_kps';
        $this->load->view('backend/home', $data);
    }
    ...
    function add_form()
    {
        ...
        $data['title'] = 'backend/sw_sop/sop_form_kps';
        $this->load->view('backend/home', $data);
    }
    ...
    function get_id($id)
    {
        $data = $this->M_sw_sop->get_by_id($id);
    ...
    public function add()
    {
        ...
        if ($parent_no && $parent_no != '') {
            $parent_data = $this->M_sw_sop->get_by_no($parent_no);
            if ($parent_data) {
        ...
        if ($jenis == 'SK Penunjang') {
            ...
            $no = $this->M_sw_sop->generate_no_hierarki($jenis, $parent_id);
    ...
    public function update()
    {
        ...
        $old_data = $this->M_sw_sop->get_by_id($id);
        ...
        if ($jenis == 'SK Penunjang') {
            ...
            if ($parent_changed || $jenis_changed || empty($old_data->no)) {
                ...
                if ($jenis != 'SOP' && empty($parent_id)) {
                    ...
                    $generated = $this->M_sw_sop->generate_no_hierarki($jenis, $parent_id);
                    if ($generated !== null) {
                        $no = $generated;
                    } else {
        ...
        $this->M_sw_sop->update($id, $data);
        echo json_encode(array("status" => TRUE));
    }

    public function delete($id)
    {
        $row = $this->M_sw_sop->get_by_id($id);
    ...
    public function get_parent_options()
    {
        ...
        $parent_options = $this->M_sw_sop->get_parent_options($jenis);
