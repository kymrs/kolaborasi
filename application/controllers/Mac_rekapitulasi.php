...
class Mac_rekapitulasi extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_mac_rekapitulasi');
    ...
    public function index()
    {
        ...
        $data['total'] = $this->M_mac_rekapitulasi->get_total_pengeluaran();

        $data['title'] = "backend/mac_rekapitulasi";
    ...
    function get_list()
    {
        ...
        $list = $this->M_mac_rekapitulasi->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_mac_rekapitulasi->count_all(),
            "recordsFiltered" => $this->M_mac_rekapitulasi->count_filtered(),
            "data" => $data,
        );
    ...
    function get_total()
    {
        $output = $this->M_mac_rekapitulasi->get_total_pengeluaran();
    ...
    public function export_excel()
    {
        ...
        $prepayment = $this->M_mac_rekapitulasi->get_data_prepayment($tgl_awal, $tgl_akhir);
        $reimbust = $this->M_mac_rekapitulasi->get_data_reimbust($tgl_awal, $tgl_akhir);
        ...
        header('Content-Disposition: attachment;filename="Data Rekapitulasi MAC.xlsx"');
