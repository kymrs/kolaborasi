...
class Rekapitulasi_by_moment extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_rekapitulasi_by_moment');
    ...
    public function index()
    {
        ...
        $data['total'] = $this->M_rekapitulasi_by_moment->get_total_pengeluaran();

        $data['title'] = "backend/rekapitulasi_by_moment";
    ...
    function get_list()
    {
        ...
        $list = $this->M_rekapitulasi_by_moment->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_rekapitulasi_by_moment->count_all(),
            "recordsFiltered" => $this->M_rekapitulasi_by_moment->count_filtered(),
            "data" => $data,
        );
    ...
    function get_total()
    {
        $output = $this->M_rekapitulasi_by_moment->get_total_pengeluaran();
    ...
    public function export_excel()
    {
        ...
        $prepayment = $this->M_rekapitulasi_by_moment->get_data_prepayment($tgl_awal, $tgl_akhir);
        $reimbust = $this->M_rekapitulasi_by_moment->get_data_reimbust($tgl_awal, $tgl_akhir);
