...
class Ctz_rekapitulasi extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_ctz_rekapitulasi');
    ...
    public function index()
    {
        ...
        $data['total'] = $this->M_ctz_rekapitulasi->get_total_pengeluaran();

        $data['title'] = "backend/ctz_rekapitulasi";
        $data['titleview'] = "Data Rekapitulasi CTZ";
    ...
    function get_list()
    {
        ...
        $list = $this->M_ctz_rekapitulasi->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        foreach ($list as $field) {
            ...
            $row[] = $field->sifat_pelaporan ?? 'Prepayment'; // Jenis transaksi
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_ctz_rekapitulasi->count_all(),
            "recordsFiltered" => $this->M_ctz_rekapitulasi->count_filtered(),
            "data" => $data,
        );
    ...
    function get_total()
    {
        $output = $this->M_ctz_rekapitulasi->get_total_pengeluaran();
    ...
    public function export_excel()
    {
        ...
        $prepayment = $this->M_ctz_rekapitulasi->get_data_prepayment($tgl_awal, $tgl_akhir);
        $reimbust = $this->M_ctz_rekapitulasi->get_data_reimbust($tgl_awal, $tgl_akhir);
