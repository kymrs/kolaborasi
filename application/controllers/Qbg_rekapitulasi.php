...
class Qbg_rekapitulasi extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_qbg_rekapitulasi');
    ...
    function get_list()
    {
        ...
        $list = $this->M_qbg_rekapitulasi->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_qbg_rekapitulasi->count_all(),
            "recordsFiltered" => $this->M_qbg_rekapitulasi->count_filtered(),
            "data" => $data,
        );
    ...
    function get_total()
    {
        $output = $this->M_qbg_rekapitulasi->get_total_pengeluaran();
    ...
    public function export_excel()
    {
        ...
        $prepayment = $this->M_qbg_rekapitulasi->get_data_prepayment($tgl_awal, $tgl_akhir);
        $reimbust = $this->M_qbg_rekapitulasi->get_data_reimbust($tgl_awal, $tgl_akhir);
        ...
        header('Content-Disposition: attachment;filename="Data Rekapitulasi QubaGift.xlsx"');
