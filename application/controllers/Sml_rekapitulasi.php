...
class Sml_rekapitulasi extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_sml_rekapitulasi');
    ...
    function get_list()
    {
        ...
        $list = $this->M_sml_rekapitulasi->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_sml_rekapitulasi->count_all(),
            "recordsFiltered" => $this->M_sml_rekapitulasi->count_filtered(),
            "data" => $data,
        );
