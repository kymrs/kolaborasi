...
class Sw_rekapitulasi extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_sw_rekapitulasi');
    ...
    public function export_excel()
    {
        ...
        header('Content-Disposition: attachment;filename="Data Rekapitulasi sebelaswarna.xlsx"');
