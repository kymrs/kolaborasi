...
class Datadeklarasi_sw extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['titleview'] = "Deklarasi Sebelaswarna";
    ...
    function read_form($id)
    {
        ...
        $data['app2_name'] = $this->db->select('name')
            ...
            ->get()
            ->row('name');
        $data['title_view'] = "Data Deklarasi Sebelaswarna";
    ...
    {
        $data['id'] = 0;
        $data['title_view'] = "Deklarasi Sebelaswarna Form";
        $data['aksi'] = 'update';
    ...
    {
        $data['id'] = $id;
        $data['title_view'] = "Edit Data Deklarasi Sebelaswarna";
        $data['title'] = 'backend/datadeklarasi_sw/deklarasi_form_sw';
        $this->load->view('backend/home', $data);
    }
