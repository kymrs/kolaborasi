...
class Rekapitulasi_sw extends CI_Controller
{
    ...
    public function export_excel()
    {
        ...
        $prepayment = $this->M_rekapitulasi_sw->get_data_prepayment($tgl_awal, $tgl_akhir);
        $reimbust = $this->M_rekapitulasi_sw->get_data_reimbust($tgl_awal, $tgl_akhir);
        ...
        header('Content-Disposition: attachment;filename="Data Rekapitulasi SW.xlsx"');
