...
class Pu_datadeklarasi extends CI_Controller
{

    function __construct()
    {
        parent::__construct();
        $this->load->model('backend/M_pu_datadeklarasi');
    ...
    public function index()
    {
        ...
        $data['title'] = "backend/pu_datadeklarasi/pu_deklarasi_list";
    ...
    function get_list()
    {
        ...
        $fullname = $this->db->select('name')
            ...
            ->get()
            ->row('name');
        $list = $this->M_pu_datadeklarasi->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        foreach ($list as $field) {
            ...
            $action_read = ($read == 'Y') ? '<a href="pu_datadeklarasi/read_form/' . $field->id . '" class="btn btn-info btn-circle btn-sm" title="Read"><i class="fa fa-eye"></i></a>&nbsp;' : '';
            $action_edit = ($edit == 'Y') ? '<a href="pu_datadeklarasi/edit_form/' . $field->id . '" class="btn btn-warning btn-circle btn-sm" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;' : '';
            $action_delete = ($delete == 'Y') ? '<a onclick="delete_data(' . "'" . $field->id . "'" . ')" class="btn btn-danger btn-circle btn-sm" title="Delete"><i class="fa fa-trash"></i></a>&nbsp;' : '';
            $action_print = ($print == 'Y') ? '<a class="btn btn-success btn-circle btn-sm" target="_blank" href="pu_datadeklarasi/generate_pdf/' . $field->id . '"><i class="fas fa-file-pdf"></i></a>' : '';
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->M_pu_datadeklarasi->count_all(),
            "recordsFiltered" => $this->M_pu_datadeklarasi->count_filtered(),
            "data" => $data,
        );
    ...
    function read_form($id)
    {
        ...
        $data['title'] = 'backend/pu_datadeklarasi/pu_deklarasi_read';
        $this->load->view('backend/home', $data);
    }
    ...
    {
        $data['master'] = $this->M_pu_datadeklarasi->get_by_id($id);
    ...
    public function generate_kode()
    {
        ...
        $kode = $this->M_pu_datadeklarasi->max_kode($date)->row();
    ...
    public function add()
    {
        ...
        $approval = $this->M_pu_datadeklarasi->approval($this->session->userdata('id_user'));
        ...
        $this->M_pu_datadeklarasi->save($data);
    ...
    function delete($id)
    {
        $this->M_pu_datadeklarasi->delete($id);
        echo json_encode(array("status" => TRUE));
    }
