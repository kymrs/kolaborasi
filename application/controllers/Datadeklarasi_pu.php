...
class Datadeklarasi_pu extends CI_Controller
{
        ...
        foreach ($list as $field) {
            ...
            if ($field->app_name == $fullname) {
                $action = '<a href="datadeklarasi_pu/read_form/' . $field->id . '" class="btn btn-info btn-circle btn-sm" title="Read"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-success btn-circle btn-sm" target="_blank" href="datadeklarasi_pu/generate_pdf/' . $field->id . '"><i class="fas fa-file-pdf"></i></a>';
    ...
    public function add()
    {
        ...
        $approval = $this->M_datadeklarasi_pu->approval($this->session->userdata('id_user'));
