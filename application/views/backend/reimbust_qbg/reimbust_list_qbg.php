        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <?php if ($add == 'Y') { ?>
                        <a class="btn btn-primary btn-sm" href="<?= base_url('reimbust_qbg/add_form') ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('reimbust_qbg/get_list') ?>",
                "type": "POST",
                "data": function(d) {
    ...
    function delete_data(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo site_url('reimbust_qbg/delete/') ?>" + id,
                    type: "POST",
                    dataType: "JSON",
