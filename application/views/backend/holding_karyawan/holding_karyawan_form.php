                    ...
                    <form id="form">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="nama_pt" class="col-sm-5 col-form-label">Nama PT</label>
                                    <div class="col-sm-7">
                                        <select id="nama_pt" name="nama_pt" class="form-control">
                                            <option value="" hidden>Pilih PT</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <select id="unit_bisnis" name="unit_bisnis" class="form-control">
                                            ...
                                            <?php if (!empty($sub_bisnis_list)) : ?>
                                                <?php foreach ($sub_bisnis_list as $sb) : ?>
                                                    <option value="<?= htmlspecialchars($sb['sub_bisnis']) ?>" <?= isset($master) && $master->unit_bisnis == $sb['sub_bisnis'] ? 'selected' : '' ?>><?= htmlspecialchars($sb['sub_bisnis']) ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <select name="posisi" id="posisi" class="form-control" required>
                                            ...
                                            <option value="Operasional Staff">Operasional Staff</option>
...
<script>
    ...
    function requestGenerateNpk(yearTwoDigits) {
        $.ajax({
            url: '<?= site_url("holding_karyawan/generate_npk") ?>',
            type: 'POST',
            dataType: 'json',
    ...
    $(document).ready(function() {
        ...
        if (id == 0) {
            ...
            $.ajax({
                url: "<?php echo site_url('holding_karyawan/edit_data') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    ...
                    $('#nama_pt').val(data['master'].nama_pt);
        ...
        function deleteFile(field) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo base_url("holding_karyawan/delete_file"); ?>', // URL controller untuk menghapus file
                        type: 'POST',
                        data: {
        ...
        $("#form").submit(function(e) {
            ...
            var url;
            if (id == 0) {
                url = "<?php echo site_url('holding_karyawan/add_data_karyawan') ?>";
            } else {
                ...
                success: function(data) {
                    ...
                    if (data.status) {
                        Swal.fire({
                            ...
                            location.href = "<?= base_url('holding_karyawan') ?>";
                        });
                    }
                },
                error: function(jqXHR, textStatus, errorThrown) {
