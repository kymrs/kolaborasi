        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header text-right">
                    <a style="background-color: rgb(36, 44, 73);" class="btn btn-secondary btn-sm" href="<?= base_url('holding_karyawan') ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <select id="status_wp" name="status_wp" class="form-control">
                                            ...
                                            <option value="HB/0">HB/0 - Hidup Berpisah, tanpa x`tanggungan</option>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#form").submit(function(e) {
            ...
            var url;
            if (id == 0) {
                url = "<?php echo site_url('holding_karyawan/add_data_keluarga') ?>";
            } else {
                url = "<?php echo site_url('holding_karyawan/update_data_keluarga') ?>";
            }
