...
<div class="mb-3" style="margin-left: 12%;">
    ...
    <div class="page">
        <div class="header">
            ...
            <p>(<span>No: <?= $transaksi->no_perjanjian ?></span>)</p>
        </div>
        ...
        <div class="content-header">
            <p>Dalam hal ini bertindak untuk dan atas nama <b><?= $pt->nama_pt ?></b>, perseroan terbatas yang didirikan menurut hukum Indonesia, selanjutnya disebut sebagai <b>PERUSAHAAN;</b></p>
            <table>
                <tr>
                    <td>Nama</td>
                    <td>:</td>
    ...
    <div class="page">
        ...
        <div class="pasal-main">
            ...
            <ol>
                <li>Para pihak sepakat, bila karena sesuatu hal PERUSAHAAN sebagai wakil <?= $pt->nama_pt ?> dalam perjanjian ini berhalangan untuk menjalankan fungsinya sebagai wakil PERUSAHAAN maka siapapun pejabat yang ditunjuk secara resmi oleh PERUSAHAAN, secara sah adalah pihak yang mewakili PERUSAHAAN;</li>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Approval Dokumen</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btnModalConfirm">Submit</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $('#btnModalConfirm').on('click', function() {
            ...
            $.ajax({
                url: '<?= site_url("holding_karyawan/approve_pkwt") ?>',
                type: 'POST',
                data: {
                    id: '<?= $transaksi->id ?>',
