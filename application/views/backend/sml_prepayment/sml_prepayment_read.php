...
<script>
    $(document).ready(function() {
        ...
        $('#appBtn').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('sml_prepayment/approve') ?>');
            $.ajax({
        ...
        $('#appBtn2').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('sml_prepayment/approve2') ?>');
        ...
        $('#appBtn3').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('sml_prepayment/approve3') ?>');
        ...
        $('#paymentBtn').click(function() {
            $('#paymentForm').attr('action', '<?= site_url('sml_prepayment/payment') ?>');
