                ...
                <div class="form-container">
                    ...
                    <div class="header">
                        <div class="header-field">
                            <img src="<?= base_url('assets/backend/img/qubagift.png') ?>" alt="" class="logo">
                            <table>
                                <tr>
...
<script>
    $(document).ready(function() {
        ...
        $('#appBtn').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('prepayment_qbg/approve') ?>');
            $.ajax({
        ...
        $('#appBtn2').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('prepayment_qbg/approve2') ?>');
        ...
        $('#paymentBtn').click(function() {
            $('#paymentForm').attr('action', '<?= site_url('prepayment_qbg/payment') ?>');
