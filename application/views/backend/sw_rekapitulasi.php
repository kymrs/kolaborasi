...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function getAjaxUrl(tab) {
            switch (tab) {
                case 'pelaporan':
                    return "<?php echo site_url('sw_rekapitulasi/get_list_pelaporan') ?>";
                case 'reimbust':
                    return "<?php echo site_url('sw_rekapitulasi/get_list_reimbust') ?>";
                case 'invoice':
                    return "<?php echo site_url('sw_rekapitulasi/get_list_invoice') ?>";
                default:
                    return "<?php echo site_url('sw_rekapitulasi/get_list') ?>"; // fallback
            }
        }
