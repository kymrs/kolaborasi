    ...
    <script>
        $(document).ready(function() {
            ...
            $('#appBtn').click(function() {
                ...
                $('#approvalForm').attr('action', '<?= site_url('sml_reimbust/approve') ?>');
                $.ajax({
                    url: "<?php echo site_url('sml_reimbust/edit_data') ?>/" + id,
                    type: "GET",
                    dataType: "JSON",
            ...
            $('#appBtn2').click(function() {
                ...
                $('#approvalForm').attr('action', '<?= site_url('sml_reimbust/approve2') ?>');
            ...
            $('#appBtn3').click(function() {
                ...
                $('#approvalForm').attr('action', '<?= site_url('sml_reimbust/approve3') ?>');
            ...
            $('#paymentBtn').click(function() {
                $('#paymentForm').attr('action', '<?= site_url('sml_reimbust/payment') ?>');
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data['master']['app_status'] != null) {
                        ...
                        status = data['master']['app_status'];
                        keterangan = data['master']['app_keterangan'];
                        url = "<?php echo site_url('sml_reimbust/approve') ?>";
                    ...
                    $('.openModal').on('click', function() {
                        ...
                        if (kwitansi) {
                            ...
                            modalImg.attr('src', `<?= base_url() ?>/assets/backend/document/reimbust/kwitansi/kwitansi_sml/${kwitansi}`);
                    ...
                    $(document).on('click', '[data-deklarasi]', function() {
                        ...
                        $.ajax({
                            url: '<?= site_url('sml_reimbust/detail_deklarasi') ?>', // URL method controller
                            method: 'POST',
                            data: {
                                deklarasi: deklarasi
                            },
