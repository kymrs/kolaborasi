    ...
    <script>
        $(document).ready(function() {
            ...
            $('#appBtn').click(function() {
                ...
                $('#approvalForm').attr('action', '<?= site_url('kps_reimbust/approve') ?>');
                $.ajax({
                    url: "<?php echo site_url('kps_reimbust/edit_data') ?>/" + id,
                    type: "GET",
                    dataType: "JSON",
            ...
            $('#appBtn2').click(function() {
                ...
                $('#approvalForm').attr('action', '<?= site_url('kps_reimbust/approve2') ?>');
            ...
            $('#paymentBtn').click(function() {
                $('#paymentForm').attr('action', '<?= site_url('kps_reimbust/payment') ?>');
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data['master']['app_status'] != null) {
                        ...
                        status = data['master']['app_status'];
                        keterangan = data['master']['app_keterangan'];
                        url = "<?php echo site_url('kps_reimbust/approve') ?>";
                        $('#note_id').append(`<p>* ${keterangan}</p>`);
                    }
                    ...
                    $(document).on('click', '[data-deklarasi]', function() {
                        ...
                        $.ajax({
                            url: '<?= site_url('kps_reimbust/detail_deklarasi') ?>', // URL method controller
                            method: 'POST',
                            data: {
                                deklarasi: deklarasi
                            },
