...
<body style="font-family: 'Poppins', sans-serif;">
    <img style="margin-bottom: -100px" src="assets/backend/img/hayfa.png" width="160">
    <br><br><br><br><br>
    ...
    <br>
    <?php if (!empty($foto)) { ?>
        <p style="font-size:15px; padding-top:-10px;"><b>Foto :</b></p>
        <div style="text-align: center;">
            <img src="assets/backend/document/mom/foto_mom_sam/<?= $foto ?>" style="max-width: 100%; max-height: 300px;">
        </div>
    <?php } ?>
</body>
