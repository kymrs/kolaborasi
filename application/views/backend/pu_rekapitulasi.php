...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function getAjaxUrl(tab) {
            switch (tab) {
                case 'pelaporan':
                    return "<?php echo site_url('pu_rekapitulasi/get_list_pelaporan') ?>";
                case 'reimbust':
                    return "<?php echo site_url('pu_rekapitulasi/get_list_reimbust') ?>";
                case 'invoice':
                    return "<?php echo site_url('pu_rekapitulasi/get_list_invoice') ?>";
                default:
                    return "<?php echo site_url('pu_rekapitulasi/get_list') ?>"; // fallback
            }
        }
        ...
        function initializeDataTable() {
            ...
            table = $('#table').DataTable({
                ...
                "drawCallback": function(settings) {
                    $.ajax({
                        "url": "<?php echo site_url('pu_rekapitulasi/get_total') ?>",
                        "type": "POST",
                        "data": {
                            "awal": $('#tgl_awal').val(),
                            "akhir": $('#tgl_akhir').val(),
    ...
    $('#btn-export-excel').click(function() {
        ...
        window.location.href = "<?= site_url('pu_rekapitulasi/export_excel'); ?>?tgl_awal=" + tgl_awal + "&tgl_akhir=" + tgl_akhir;
    });
</script>