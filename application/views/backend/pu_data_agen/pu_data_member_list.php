        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header d-flex justify-content-between align-items-center py-3">
                    <a class="btn btn-primary btn-sm" href="<?= base_url("pu_customer/add_form") ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#member-table').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('pu_data_agen/get_list2') ?>",
                "type": "POST",
            },
            "language": {
                "infoFiltered": ""
    ...
    $("#formStatusMember").submit(function(e) {
        e.preventDefault();
        var url = "<?php echo site_url('pu_data_agen/update_status_member') ?>";
        $.ajax({
            url: url,
            type: "post",
            data: $(this).serialize(),
    ...
    $('#formStatusMember').on('submit', function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?php echo base_url("pu_data_agen/update_status_member"); ?>',
            type: 'POST',
            data: $(this).serialize(),
            dataType: 'json',
    ...
    function showInsentifModal(no_telp, nama_member) {
        ...
        $('#tableInsentifMember').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('pu_data_agen/get_insentif_member'); ?>",
                "type": "POST",
                "data": {
                    no_telp: no_telp
                }
    ...
    $('#formPaymentStatus').on('submit', function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?php echo base_url("pu_data_agen/update_payment_status_member"); ?>',
            type: 'POST',
            data: $(this).serialize(),
            dataType: 'json',
            success: function(res) {
    ...
    $('#formTambahInsentif').on('submit', function(e) {
        ...
        var id = $('[name="id"]').val();
        var url = id ?
            '<?php echo base_url("pu_data_agen/update_insentif_member"); ?>' :
            '<?php echo base_url("pu_data_agen/tambah_insentif_member"); ?>';
