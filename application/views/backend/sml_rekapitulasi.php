...
<<<<<<< HEAD
        function getAjaxUrl(tab) {
            switch (tab) {
                case 'pelaporan':
                    return "<?php echo site_url('sml_rekapitulasi/get_list_pelaporan') ?>";
                case 'reimbust':
                    return "<?php echo site_url('sml_rekapitulasi/get_list_reimbust') ?>";
                case 'invoice':
                    return "<?php echo site_url('sml_rekapitulasi/get_list_invoice') ?>";
                default:
                    return "<?php echo site_url('sml_rekapitulasi/get_list') ?>"; // fallback
            }
        }
...
<<<<<<< HEAD
                    "url": ajaxUrl,
=======
                    "url": "<?php echo site_url('sml_rekapitulasi/get_list') ?>",
>>>>>>> 01baacc0bc7ac03d364f8779f5d23138bd323641
                    "type": "POST",
                    "data": function(d) {
...
>>>>>>> 01baacc0bc7ac03d364f8779f5d23138bd323641
                "drawCallback": function(settings) {
                    $.ajax({
                        "url": "<?php echo site_url('sml_rekapitulasi/get_total') ?>",
                        "type": "POST",
                        "data": {
                            "awal": $('#tgl_awal').val(),
                            "akhir": $('#tgl_akhir').val(),
...
>>>>>>> 01baacc0bc7ac03d364f8779f5d23138bd323641
    ...
    $('#btn-export-excel').click(function() {
        ...
        window.location.href = "<?= site_url('sml_rekapitulasi/export_excel'); ?>?tgl_awal=" + tgl_awal + "&tgl_akhir=" + tgl_akhir;
    });
</script>