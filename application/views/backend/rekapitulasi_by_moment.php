...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function initializeDataTable() {
            table = $('#table').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo site_url('rekapitulasi_by_moment/get_list') ?>",
                    "type": "POST",
                    "data": function(d) {
                ...
                "drawCallback": function(settings) {
                    $.ajax({
                        "url": "<?php echo site_url('rekapitulasi_by_moment/get_total') ?>",
                        "type": "POST",
                        "data": {
                            "awal": $('#tgl_awal').val(),
                            "akhir": $('#tgl_akhir').val(),
    ...
    $('#btn-export-excel').click(function() {
        ...
        window.location.href = "<?= site_url('rekapitulasi_by_moment/export_excel'); ?>?tgl_awal=" + tgl_awal + "&tgl_akhir=" + tgl_akhir;
    });
</script>