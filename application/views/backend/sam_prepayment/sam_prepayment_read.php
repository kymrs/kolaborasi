...
<script>
    $(document).ready(function() {
        ...
        $('#appBtn').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('sam_prepayment/approve') ?>');
            $.ajax({
        ...
        $('#appBtn2').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('sam_prepayment/approve2') ?>');
        ...
        $('#appBtn3').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('sam_prepayment/approve3') ?>');
        ...
        $('#attachment').closest('.form-group').hide();
         ...
         $('#paymentBtn').click(function() {
            $('#paymentForm').attr('action', '<?= site_url('sam_prepayment/payment') ?>');
                $.ajax({
                    url: "<?php echo site_url('sam_prepayment/edit_data') ?>/" + id,
                    type: "GET",
                    dataType: "JSON",
