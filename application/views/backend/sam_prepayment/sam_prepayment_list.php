        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <?php if ($add == 'Y') { ?>
                        <a class="btn btn-primary btn-sm" href="<?= base_url('sam_prepayment/add_form') ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('sam_prepayment/get_list') ?>",
                "type": "POST",
                "data": function(d) {
    ...
    function delete_data(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo site_url('sam_prepayment/delete/') ?>" + id,
                    type: "POST",
                    dataType: "JSON",
    ...
    $('#paymentDetailModal').on('show.bs.modal', function(e) {
        ...
        var attachmentPath = baseUrl + "assets/backend/document/prepayment/attachment/sam_attachment/";
        
        $.ajax({
            url: "<?= site_url('sam_prepayment/edit_data') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
