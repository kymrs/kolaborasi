...
<script>
    $(document).ready(function() {
        ...
        $('#appBtn').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('prepayment_by_moment/approve') ?>');
            $.ajax({
        ...
        $('#appBtn2').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('prepayment_by_moment/approve2') ?>');
        ...
        $('#paymentBtn').click(function() {
            $('#paymentForm').attr('action', '<?= site_url('prepayment_by_moment/payment') ?>');
