...
<script>
    $('#tgl_notifikasi').datepicker({
        ...
        onSelect: function(dateText) {
            ...
            $.ajax({
                url: "<?php echo site_url('datanotifikasi_pw/generate_kode') ?>",
                type: "POST",
                data: {
                    "date": dateText
                },
    ...
    $(document).ready(function() {
        ...
        if (id == 0) {
            ...
            $.ajax({
                url: "<?php echo site_url('datanotifikasi_pw/edit_data') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    // console.log(data);
        ...
        $("#form").submit(function(e) {
            ...
            var url = (id == 0) ? "<?php echo site_url('datanotifikasi_pw/add') ?>" : "<?php echo site_url('datanotifikasi_pw/update') ?>";
