        ...
        function addRow() {
            ...
            const row = `
                <tr id="row-${rowCount}">
                    ...
                    <td><input type="text" class="form-control" name="pemakaian[${rowCount}]" value="" placeholder="Pemakaian ${rowCount}"></td>
                    <td>
                            ...
                            const row = `
                                <tr id="row-${index}">
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control" name="kwitansi_image" value="${data['transaksi'][index]['kwitansi']}">
                                    </td>
