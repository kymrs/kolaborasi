        ...
        <div class="form-container">
            ...
            <div class="table-main">
                <table>
                    <thead>
                        <tr>
                            <td colspan="4" style="font-weight: bold">JUMLAH PREPAYMENT <span style="float: right; margin-right: 10px">Rp. 500.000</span></td>
                    ...
                    <tr>
                        <td colspan="6" style="font-weight: bold">TOTAL PEMAKAIAN : Rp. 500.000</span></td>
                    </tr>
                    <tr>
                        <td colspan="6" style="font-weight: bold">SISA PREPAYMENT : Rp. 500.000</span></td>
                    </tr>
                </table>
            </div>
