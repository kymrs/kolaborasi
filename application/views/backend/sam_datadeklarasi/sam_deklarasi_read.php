...
<script>
    $(document).ready(function() {
        ...
        $('#appBtn').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('sam_datadeklarasi/approve') ?>');
        ...
        $('#appBtn2').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('sam_datadeklarasi/approve2') ?>');
        ...
        $('#appBtn3').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('sam_datadeklarasi/approve3') ?>');
