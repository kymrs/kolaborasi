...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#main-table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('knms_sk/get_list') ?>",
                "type": "POST",
            },
            "language": {
                "infoFiltered": ""
    ...
    $("#modalform").submit(function(e) {
        ...
        if (method == 'add') {
            url = "<?php echo site_url('knms_sk/add') ?>";
        } else {
            url = "<?php echo site_url('knms_sk/update') ?>";
        }
    ...
    function edit_data(id) {
        ...
        $('.aksi').text('Update');
        $.ajax({
            url: "<?php echo site_url('knms_sk/get_id/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                $('[name="id"]').val(data.id);
    ...
    function delete_data(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo site_url('knms_sk/delete') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data) {
                        Swal.fire({
