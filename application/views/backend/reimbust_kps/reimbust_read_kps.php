...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <span class="no-prepayment_kps">No. Prepayment : <span id="kode_reimbust"></span></span>
            <div class="clear"></div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#appBtn').click(function() {
                ...
                $('#approvalForm').attr('action', '<?= site_url('reimbust_kps/approve') ?>');
                $.ajax({
                    url: "<?php echo site_url('reimbust_kps/edit_data') ?>/" + id,
                    type: "GET",
                    dataType: "JSON",
            ...
            $('#appBtn2').click(function() {
                ...
                $('#approvalForm').attr('action', '<?= site_url('reimbust_kps/approve2') ?>');
            ...
            $('#paymentBtn').click(function() {
                $('#paymentForm').attr('action', '<?= site_url('reimbust_kps/payment') ?>');
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data['master']['app_status'] != null) {
                        ...
                        status = data['master']['app_status'];
                        keterangan = data['master']['app_keterangan'];
                        url = "<?php echo site_url('reimbust_kps/approve') ?>";
                        $('#note_id').append(`<p>* ${keterangan}</p>`);
                    }
                    ...
                    if (data['master']['app2_status'] != null) {
                        ...
                        status2 = data['master']['app2_status'];
                        keterangan2 = data['master']['app2_keterangan'];
                        url = "<?php echo site_url('prepayment_kps/approve2') ?>";
                        $('#note_id').append(`<p>* ${keterangan2}</p>`);
                    }
                    ...
                    $(document).on('click', '[data-deklarasi]', function() {
                        ...
                        $.ajax({
                            url: '<?= site_url('reimbust_kps/detail_deklarasi') ?>', // URL method controller
                            method: 'POST',
                            data: {
                                deklarasi: deklarasi
                            },
            ...
            // $('#keterangan').append(`<span class="form-control-plaintext">*Berikut ini merupakan catatan keterangan prepayment_kps.</span>`);
        });
    </script>
</body>
