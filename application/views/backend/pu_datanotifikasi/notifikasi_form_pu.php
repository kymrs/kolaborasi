...
<script>
    $('#tgl_notifikasi').datepicker({
        ...
        onSelect: function(dateText) {
            ...
            $.ajax({
                url: "<?php echo site_url('pu_datanotifikasi/generate_kode') ?>",
                type: "POST",
                data: {
                    "date": dateText
                },
    ...
    $(document).ready(function() {
        ...
        if (id == 0) {
            ...
            $.ajax({
                url: "<?php echo site_url('pu_datanotifikasi/edit_data') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    // console.log(data);
        ...
        $("#form").submit(function(e) {
            ...
            var url = (id == 0) ? "<?php echo site_url('pu_datanotifikasi/add') ?>" : "<?php echo site_url('pu_datanotifikasi/update') ?>";
                ...
                success: function(data) {
                    ...
                    if (data.status) {
                        Swal.fire({
                            ...
                            location.href = "<?= base_url('pu_datanotifikasi') ?>";
                        });
                    }
                },
                error: function(jqXHR, textStatus, errorThrown) {
