        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <?php if ($add == 'Y') { ?>
                        <a class="btn btn-primary btn-sm" href="<?= base_url('pu_datanotifikasi/add_form') ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = $('#notificationTable').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('pu_datanotifikasi/get_list') ?>",
                "type": "POST",
                "data": function(d) {
        ...
        window.delete_data = function(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo site_url('pu_datanotifikasi/delete/') ?>" + id,
                        type: "POST",
                        dataType: "JSON",
