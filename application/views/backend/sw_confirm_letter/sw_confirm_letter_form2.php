                    ...
                    <form id="form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="total_amount" name="total_amount" placeholder="0" data-hidden="total_amount_hidden">
                                ...
                                <div class="row align-items-center mb-3">
                                    <label class="col-lg-4" for="dp_amount">DP Amount</label>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="dp_amount" name="dp_amount" placeholder="0" data-hidden="dp_amount_hidden">
                                            <input type="hidden" id="dp_amount_hidden" name="dp_amount_value">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row align-items-center mb-3">
                                    <label class="col-lg-4" for="final_amount">Final Amount</label>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="final_amount" name="final_amount" placeholder="0" data-hidden="final_amount_hidden">
                                            <input type="hidden" id="final_amount_hidden" name="final_amount_value">
                                        </div>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        ['total_amount', 'dp_amount', 'final_amount'].forEach(function(fieldId) {
        ...
        if (id != 0) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#dp_amount').val(formatCurrency(data.dp_amount)).trigger('input');
                    $('#final_amount').val(formatCurrency(data.final_amount)).trigger('input');
        ...
        $("#form").submit(function(e) {
            ...
            formDataObj.set('dp_amount', $('#dp_amount_hidden').val() || 0);
            formDataObj.set('final_amount', $('#final_amount_hidden').val() || 0);
        ...
        $("#form").validate({
            ...
            messages: {
                ...
                // dp_amount: {
                //     required: "DP amount is required",
                // },
                // dp_date: {
                //     required: "DP date is required",
                // },
                // final_amount: {
