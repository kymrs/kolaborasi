            ...
            <div class="container">
                <div class="form-container">
                    <div class="d-flex justify-content-end mb-3">
                        <?php if ($user->app_name == $app_name || $user->app2_name == $app2_name) { ?>
                        ...
                        <?php } ?>
                        <a class="btn btn-secondary btn-sm" href="<?= base_url('prepayment_pw') ?>"><i class="fas fa-chevron-left"></i>&nbsp;Back</a>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#appBtn').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('prepayment_pw/approve') ?>');
            $.ajax({
                url: "<?php echo site_url('prepayment_pw/edit_data') ?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        $('#appBtn2').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('prepayment_pw/approve2') ?>');
        ...
        $('#paymentBtn').click(function() {
            $('#paymentForm').attr('action', '<?= site_url('prepayment_pw/payment') ?>');
                    ...
                    success: function(data) {
                        ...
                        if (data.status) //if success close modal and reload ajax table
                        {
                            Swal.fire({
                                ...
                                location.href = "<?= base_url('prepayment_pw') ?>";
                            })
                        }
                    },
                    error: function(jqXHR, textStatus, errorThrown) {
