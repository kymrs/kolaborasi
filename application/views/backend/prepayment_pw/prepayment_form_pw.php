...
<script>
    $('#tgl_prepayment').datepicker({
        ...
        onSelect: function(dateText) {
            ...
            $.ajax({
                url: "<?php echo site_url('prepayment_pw/generate_kode') ?>",
                type: "POST",
                data: {
                    "date": dateText
                },
    ...
    $(document).ready(function() {
        ...
        if (aksi == "read") {
            ...
            $.ajax({
                url: "<?php echo site_url('prepayment_pw/read_detail/') ?>" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
        ...
        $("#form").submit(function(e) {
            ...
            var url;
            if (id == 0) {
                url = "<?php echo site_url('prepayment_pw/add') ?>";
            } else {
                url = "<?php echo site_url('prepayment_pw/update') ?>";
            }
