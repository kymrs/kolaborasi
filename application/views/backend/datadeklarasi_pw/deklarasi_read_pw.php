            ...
            <div class="container-main">
                <div class="form-container">
                    <div class="d-flex justify-content-end mb-3">
                        ...
                        <?php } ?>
                        <a class="btn btn-secondary btn-sm" href="<?= base_url('datadeklarasi_pw') ?>"><i class="fas fa-chevron-left"></i>&nbsp;Back</a>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#appBtn').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('datadeklarasi_pw/approve') ?>');

            // Additional logic to dynamically load data into the form
            $.ajax({
                url: "<?php echo site_url('datadeklarasi_pw/edit_data') ?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        $('#appBtn2').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('datadeklarasi_pw/approve2') ?>');
                    ...
                    success: function(data) {
                        ...
                        if (data.status) //if success close modal and reload ajax table
                        {
                            Swal.fire({
                                ...
                                location.href = "<?= base_url('datadeklarasi_pw') ?>";
                            })
                        }
                    },
                    error: function(jqXHR, textStatus, errorThrown) {
