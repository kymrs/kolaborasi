<div class="card-body">
    <table class="table table-bordered table-hover" id="vakses">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <td class="bg-success" style="color: white;"><?= $i++; ?></td>
                    <td class="bg-success" style="color: white;"><?= $row->nama_menu ?></td>
                    <td>
                        ...
                        <?php } else { ?>
                            <div id="vucek<?= $i . $row->id ?>" onClick="unchecked('<?= $row->id ?>','<?= $row->id_level ?>')">
                                <i class="fa fa-times-circle btn" style="color:red;"></i>
                            </div>
                ...
                <?php foreach ($data_submenu as $sub) {
                    if ($sub->id_menus == $row->id_menu) {
                ?>
                        <tr>
                            <td></td>
                            <td class="bg-info" style="color: white;"><?= $sub->nama_submenu ?></td>
                            <td>
