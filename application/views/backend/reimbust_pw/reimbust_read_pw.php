...
<body>
    <div class="container">
        <div class="d-flex justify-content-end mb-3" style="margin-right: 19px">
            ...
            <?php } ?>
            <a class="btn btn-secondary btn-sm" href="<?= base_url('reimbust_pw') ?>"><i class="fas fa-chevron-left"></i>&nbsp;Back</a>
        </div>
        <div class="form-container">
            <!-- Header -->
            <div class="header">
                <div class="logo">
                    <img src="<?= base_url() ?>assets/backend/img/pengenwisata.png" alt="Logo">
                </div>
                <div class="title">
