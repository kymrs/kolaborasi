...
<body style="font-family: 'Poppins', sans-serif;">
    <img style="margin-top:-30px; margin-right:-56px; float: right;" src="assets/backend/img/header-ctz.png" width="600">
    <br><br><br><br><br>
    ...
    <div style="text-align: center;">
        <img src="assets/backend/document/mom/foto_mom_ctz/<?= $foto ?>" style="max-width: 100%; max-height: 300px;">
    </div>

    <div style="padding-left:-56px; position: absolute; bottom: 25px;">
        <img src="assets/backend/img/footer-ctz.png" width="793">
    </div>
</body>
