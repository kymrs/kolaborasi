        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header text-right">
                    <a class="btn btn-secondary btn-sm" href="<?= base_url('swi_prepayment') ?>"><i class="fas fa-chevron-left"></i>&nbsp;Back</a>
                </div>
                <div class="card-body">
                    <form id="form">
                        <div class="row">
...
<script>
    $('#tgl_prepayment').datepicker({
        ...
        onSelect: function(dateText) {
            ...
            $.ajax({
                url: "<?php echo site_url('swi_prepayment/generate_kode') ?>",
                type: "POST",
                data: {
                    "date": dateText
                },
    ...
    $(document).ready(function() {
        ...
        if (aksi == "read") {
            ...
            $.ajax({
                url: "<?php echo site_url('swi_prepayment/read_detail/') ?>" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
        ...
        $("#form").submit(function(e) {
            ...
            var url;
            if (id == 0) {
                url = "<?php echo site_url('swi_prepayment/add') ?>";
            } else {
                url = "<?php echo site_url('swi_prepayment/update') ?>";
            }
