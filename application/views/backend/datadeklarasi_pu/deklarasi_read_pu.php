            ...
            <div class="container-main">
                <div class="form-container">
                    <div class="d-flex justify-content-end mb-3">
                        ...
                        <?php } ?>
                        <a class="btn btn-secondary btn-sm" href="<?= base_url('datadeklarasi_pu') ?>"><i class="fas fa-chevron-left"></i>&nbsp;Back</a>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#appBtn').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('datadeklarasi_pu/approve') ?>');

            // Additional logic to dynamically load data into the form
            $.ajax({
                url: "<?php echo site_url('datadeklarasi_pu/edit_data') ?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        $('#appBtn2').click(function() {
            ...
            $('#approvalForm').attr('action', '<?= site_url('datadeklarasi_pu/approve2') ?>');
