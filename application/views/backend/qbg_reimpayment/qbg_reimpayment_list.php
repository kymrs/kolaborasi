...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table1').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('qbg_reimbust/get_list') ?>",
                "type": "POST",
                "data": function(d) {
        ...
        table2 = $('#table2').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('qbg_prepayment/get_list') ?>",
                "type": "POST",
                "data": function(d) {
                    d.status = $('#appFilter').val();
                    d.tab = $('.nav-tabs .nav-link.active').data('tab');
    ...
    $('#paymentDetailModal').on('show.bs.modal', function(e) {
        ...
        var attachmentPath = baseUrl + "assets/backend/document/reimbust/attachment/qbg_attachment/";
    ...
    $('#paymentDetailModalPrepayment').on('show.bs.modal', function(e) {
        ...
        var id = paymentBtn.data('id');
        var baseUrl = "<?= base_url() ?>";
        var attachmentPath = baseUrl + "assets/backend/document/prepayment/attachment/qbg_attachment/";
        
        $.ajax({
            url: "<?= site_url('qbg_prepayment/edit_data') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                var tglPembayaran = data.master.tgl_pembayaran;
