...
<head>
    ...
    <link rel="icon" href="<?= base_url() ?>/assets/backend/img/logo-sw-title.png" type="image/jpg">
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/backend/plugins/sb2/css/sb-admin-2.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>assets/backend/plugins/jquery-ui/jquery-ui.min.css">
